...
class BusinessRegisters extends Component {
  ...
  async componentWillReceiveProps (nextProps) {
    if (
      this.props.createBusinessRegister !== nextProps.createBusinessRegister &&
      nextProps.createBusinessRegister
    ) {
      await this._toggleModal(false, false)
      this.props.getBusiness()
    }
    if (
      this.props.updateBusinessRegister !== nextProps.updateBusinessRegister &&
      nextProps.updateBusinessRegister
    ) {
      await this._toggleModal(false, false)
      this.props.getBusiness()
    }
    if (
      this.props.deleteBusinessRegister !== nextProps.deleteBusinessRegister &&
      nextProps.deleteBusinessRegister
    ) {
      this.props.getBusiness()
    }
  }
  ...
  _toggleModalConfirmDelete = (id, registerType) => {
    if (id === 'confirm') {
      this._removeBusinessRegister(
        this.state.idBusinessRegisterTodelete,
                    ...
                    <Table.Row active key={sourceOptions.key}>
                      ...
                      <Table.Cell>
                        ...
                        <Icon
                          ...
                          color="red"
                          onClick={() =>
                            this._toggleModalConfirmDelete(
                              sourceOptions.value,
                              1
                            )
                          }
                    ...
                    <Table.Row active key={typeOptions.key}>
                      ...
                      <Table.Cell>
                        ...
                        <Icon
                          ...
                          color="red"
                          onClick={() =>
                            this._toggleModalConfirmDelete(typeOptions.value, 5)
                          }
                        />
                      </Table.Cell>
                    </Table.Row>
                    ...
                    <Table.Row active key={ownersTimeOptions.key}>
                      ...
                      <Table.Cell>
                        <Icon
                          ...
                          name="edit"
                          onClick={() =>
                            this._toggleModal(ownersTimeOptions, 6)
                          }
                        />
                        <Icon
                          link
                      ...
                      <Table.Row active key={stageNotSignedOptions.key}>
                        ...
                        <Table.Cell>
                          <Icon
                            ...
                            name="edit"
                            onClick={() =>
                              this._toggleModal(stageNotSignedOptions, 8)
                            }
                          />
                          <Icon
                            link
                    ...
                    <Table.Row active key={stageNotWantOptions.key}>
                      ...
                      <Table.Cell>
                        <Icon
                          ...
                          name="edit"
                          onClick={() =>
                            this._toggleModal(stageNotWantOptions, 9)
                          }
                        />
                        <Icon
                          link
...
const mapDispatchToProps = dispatch =>
  bindActionCreators({ getBusiness, removeBusinessRegister }, dispatch)
