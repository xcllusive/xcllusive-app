      ...
      <div>
        <Grid centered>
          ...
          <Grid.Column textAlign="center" width={5}>
            ...
            />
            <Button
              color="facebook" //onClick={() => this._toggleModal(true)}
            >
              <Icon name="add" />
              New Buyer
            </Button>
            ...
            {arrayIMWaitingApproval.map(IMWaitingApproval => {
              return (
                <Table.Row
                  ...
                  onClick={() =>
                    this.props.history.push(
                      `${this.props.match.path}/${IMWaitingApproval.businessID}`
                    )
                  }
                >
            ...
            {arrayBrokersProgress.map(brokersProgress => {
              return (
                ...
                >
                  ...
                  <Table.Cell>{brokersProgress.daysSinceGenerated}</Table.Cell>
