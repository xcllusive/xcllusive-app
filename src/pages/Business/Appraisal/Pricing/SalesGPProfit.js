    ...
    return (
      <Grid celled="internally" divided>
        ...
        <Grid.Row columns={7}>
          ...
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales1 > 0 ? numeral(appraisalObject.sales1).format('$0,0.[99]') : null}
          </Grid.Column>
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales2 > 0 ? numeral(appraisalObject.sales2).format('$0,0.[99]') : null}
          </Grid.Column>
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales3 > 0 ? numeral(appraisalObject.sales3).format('$0,0.[99]') : null}
          </Grid.Column>
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales4 > 0 ? numeral(appraisalObject.sales4).format('$0,0.[99]') : null}
          </Grid.Column>
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales5 > 0 ? numeral(appraisalObject.sales5).format('$0,0.[99]') : null}
          </Grid.Column>
          <Grid.Column textAlign="center">
            {appraisalObject && appraisalObject.sales6 > 0 ? numeral(appraisalObject.sales6).format('$0,0.[99]') : null}
          </Grid.Column>
        </Grid.Row>
        <Grid.Row columns={7}>
