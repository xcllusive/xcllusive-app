...
export const TypesModal = {
  ...
  MODAL_TYPE_NEW_DOCUMENT_FILE: 'MODAL_TYPE_NEW_DOCUMENT_FILE',
  MODAL_TYPE_NEW_GROUP_EMAIL_FOLDER: 'MODAL_TYPE_NEW_GROUP_EMAIL_FOLDER',
  MODAL_TYPE_NEW_GROUP_EMAIL_TEMPLATE: 'MODAL_TYPE_NEW_GROUP_EMAIL_TEMPLATE',
  MODAL_TYPE_SEND_EMAIL: 'MODAL_TYPE_SEND_EMAIL',
  MODAL_ISSUE_REGISTER: 'MODAL_ISSUE_REGISTER',
  MODAL_SELECT_ISSUE: 'MODAL_SELECT_ISSUE'
}
